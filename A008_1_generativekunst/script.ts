namespace A008_1_generativekunst {
  /*
  ...
  */
  ...
  class GeneratedCircle extends GeneratedObject {
    ...
    constructor(x: number, y: number, color: string, radius: number, speedX: number, speedY: number) {
  ...
  class GeneratedLine extends GeneratedObject {
    ...
    constructor(x1: number, y1: number, x2: number, y2: number, color: string, speedX: number, speedY: number) {
  ...
  class GeneratedParaglider extends GeneratedObject {
    ...
    constructor(x: number, y: number, color: string, width: number, height: number, speedX: number, speedY: number) {
      super(x, y, color, speedX, speedY);
      this.width = width;
      this.height = height;
    }
  ...
  let generatedObjects: GeneratedObject[] = [];
