namespace A008_1_generativekunst {
  ...
  let gradient: CanvasGradient = crc2!.createRadialGradient(canvas.width / 2, canvas.height / 2, getRandomDecimal(), canvas.width / 2, canvas.height / 2, Math.min(canvas.width, canvas.height) / 2);
