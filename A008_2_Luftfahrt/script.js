...
(function (A008_2_Luftfahrt) {
    ...
    function drawTrees() {
        ...
        for (let i = 0; i < numTrees; i++) {
            ...
            crc2.bezierCurveTo(treeX - controlPointOffsetX, treeY - trunkHeight - controlPointOffsetY, treeX - controlPointOffsetX, crownTopY + controlPointOffsetY, treeX, crownTopY);
            crc2.bezierCurveTo(treeX + controlPointOffsetX, crownTopY + controlPointOffsetY, treeX + controlPointOffsetX, treeY - trunkHeight - controlPointOffsetY, treeX, treeY - trunkHeight);
            crc2.closePath();
            crc2.fill();
        }
    }
